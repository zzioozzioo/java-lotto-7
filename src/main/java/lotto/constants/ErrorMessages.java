...
public class ErrorMessages {
    ...
    public static final String NUMBER_OUT_OF_RANGE_ERROR = ERROR_MESSAGES_PREFIX + "번호는 1 이상 45 이하의 자연수여야 합니다.";

    public static final String INVALID_LOTTO_NUMBER_COUNT_ERROR = ERROR_MESSAGES_PREFIX + "로또 번호는 6개여야 합니다.";
    public static final String DUPLICATED_LOTTO_NUMBER_ERROR = ERROR_MESSAGES_PREFIX + "중복된 번호가 있습니다. 다시 입력해 주세요.";
}
